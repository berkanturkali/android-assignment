package com.arabam.android.assignment.feature.listing.adapter.viewholder
...
import com.arabam.android.assignment.feature.listing.databinding.AdvertLoadStateFooterItemLayoutBinding
...
class AdvertLoadStateViewHolder(
    ...
    companion object {
        fun create(parent: ViewGroup, retry: () -> Unit): AdvertLoadStateViewHolder {
            val view =
                AdvertLoadStateFooterItemLayoutBinding.bind(
                    parent.inflate(R.layout.advert_load_state_footer_item_layout)
                )
