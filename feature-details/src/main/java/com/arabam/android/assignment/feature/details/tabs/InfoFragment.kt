...
import com.arabam.android.assignment.feature.details.adapter.InfoFragmentAdapter
import com.arabam.android.assignment.feature.details.databinding.FragmentInfoLayoutBinding
...
class InfoFragment : Fragment(R.layout.fragment_info_layout) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val infoList = arguments?.getParcelableArray(Constants.INFO_KEY)!!
            .toList() as List<Info>
